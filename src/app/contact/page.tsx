                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about any relevant experience, projects, or skills..."
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {['Web Development', 'Data Science', 'AI/ML', 'Mobile Apps', 'Cybersecurity', 'Cloud Computing', 'Product Management', 'Consulting'].map((interest) => (
                    ...
                    <button
                      type="submit"
                      className="w-full group relative px-8 py-4 bg-white text-black rounded-xl font-semibold hover:bg-white/90 transition-all duration-300 hover:scale-105"
                    >
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-white/70">placeholder<br />Columbia University</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-white/70">Thursdays, 6:00 PM - 8:00 PM</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all duration-500 group-hover:scale-105">
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center hover:bg-white/20 transition-all duration-300 hover:scale-110">
        ...
        <div className="py-32 relative">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="space-y-6">
              {[
                {
                  question: "Do I need prior consulting experience to join?",
                  answer: "No prior experience is required! We welcome students from all backgrounds who are interested in learning about technology consulting."
                },
                {
                  question: "What time commitment is expected?",
                  answer: "We meet weekly  blah blah blah"
                },
                {
                ...
                {
                  question: "What majors are welcome?",
                  answer: "We welcome students from all majors! Our projects benefit from diverse perspectives including computer science, business, engineering, and more."
                }
              ].map((faq, index) => (
